package com.example.self.generator;
...
public class CodeGenerator {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/sharding?useUnicode=true&characterEncoding=utf-8&useSSL=true&allowMultiQueries=true";

    private static final String moduleName = "reg";


    private static final String[] tableName = {
            "reg_taxpayer_member",
            "reg_taxpayer_stakeholder"
    };
        ...
        FastAutoGenerator.create(URL,
                ...
                .packageConfig(builder -> {
                    builder
                            ...
                            .xml("mapper.xml")
                            .pathInfo(Collections.singletonMap(OutputFile.xml, projectPath + "/src/main/resources/"+moduleName+"/mapper/xml")).build();
                })
                ...
                .strategyConfig(builder -> {
                    builder.enableCapitalMode()//驼峰
                            .enableSkipView()//跳过视图
                            .disableSqlFilter()
                            .addTablePrefix(moduleName+"_") // 增加过滤表前缀
